...
from keras.layers import Dense, Dropout, Input, BatchNormalization, UpSampling2D, Cropping2D, Flatten, GlobalMaxPooling2D, Flatten
...
def build_model(lrate=learning_rate_tl1, opt='adam', epochs=nb_epochs_tl1, decay=0.0):
    ...
    model = Model(input_lay, outputs=[y1, y2, y3])
