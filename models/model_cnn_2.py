...
def build_model(lrate=learning_rate_tl1, opt='adam', epochs=nb_epochs_tl1, decay=0.0):
    ...
    out_q = Dense(4, activation='softmax', name='quads_pre')(y1)
    ...
    out_a = Dense(2, activation='softmax', name='arousal')(y2)
    cond_a = Dense(4, activation='softmax', kernel_initializer='glorot_uniform', name='cond_aro_fc')(out_a)
    ...
    out_v = Dense(2, activation='softmax', name='valence')(y3)
    cond_v = Dense(4, activation='softmax', kernel_initializer='glorot_uniform', name='cond_val_fc')(out_v)

    conc = Concatenate()([cond_a, cond_v, out_q])
    out_q = Dense(4, activation='softmax', kernel_initializer='glorot_uniform', name='quadrants')(conc)
